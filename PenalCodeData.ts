...
PenalCode[1] = {
	...
	Statutes: {
		1: {
			...
			fine: 800,
			color: "green",
			description: "A person who steals or takes the personal property of another worth $200 or less is guilty under this code section.",
		},
		2: {
			title: "Grand Theft",
			class: "Misdemeanor",
			...
			fine: 1400,
			color: "green",
			description: "A person who steals or takes the personal property of another worth more than $950 or a firearm of any value is guilty under this code section.",
		},
		3: {
		...
		5: {
			...
			fine: 5500,
			color: "orange",
			description: "A person who commits the theft of a motor vehicle from another personw while it is being operated is guilty under this code section.",
		},
		6: {
			title: "Burglary",
			class: "Misdemeanor",
			...
			fine: 5000,
			color: "green",
			description: "A person who enters a structure without the permission of the owner or agent of the owner is guilty under this code section.",
		},
		7: {
			title: "Robbery",
			class: "Felony",
		...
		13: {
			...
			fine: 10000,
			color: "orange",
			description: "A person who steals or takes the personal property of another worth more than $1000 is guilty under this code section.",
		},
		14: {
			...
			fine: 500,
			color: "green",
			description: "A person who leaves a billed premesis without paying the total amount of their bill is guilty under this code section.",
		},
		15: {
			...
			fine: 7500,
			color: "green",
			description: "A person who attempts to use fraudulent currency in the attempt to pass it off as legal tender is guilty under this code section.",
		},
		16: {
...
PenalCode[3] = {
	...
	Statutes: {
		1: {
			...
			fine: 4550,
			color: "green",
			description: "A person who remains on a property after being told to leave by the property owner, an agent of the property owner, or a peace officer is guilty under this code section..",
		},
		2: {
...
PenalCode[5] = {
	...
	Statutes: {
		...
		6: {
			...
			fine: 5000,
			color: "green",
			description: "A person who shows a clear and motivated attempt to prevent a government employee from conducting their duties is guilty under this code section.",
		},
		7: {
...
PenalCode[6] = {
	...
	Statutes: {
		1: {
			...
			fine: 1520,
			color: "green",
			description: "A person who is in possession of a small quantity of illegal marijuana is guilty under this code section.",
		},
		2: {
			...
			fine: 2000,
			color: "green",
			description: "A person who is in possession of a large quantity of illegal marijuana is guilty under this code section.",
		},
		3: {
			...
			fine: 2750,
			color: "green",
			description: "A person who farms or cultivates illegal marijuana of a quantity no more than 500 grams is guilty under this code section.",
		},
		4: {
			...
			fine: 6050,
			color: "orange",
			description: "A person who farms or cultivates illegal marijuana of a quantity more than 500 grams is guilty under this code section.",
		},
		5: {
			...
			fine: 5000,
			color: "orange",
			description: "A person who is carrying illegal marijuana, either in a quantity over 1kg, or packaged for sale, is guilty under this code section.",
		},
		6: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of cocaine under 500 grams is guilty under this code section.",
		},
		7: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of cocaine over 500 grams is guilty under this code section.",
		},
		8: {
			...
			fine: 10000,
			color: "orange",
			description: "A person who is carrying cocaine, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		9: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of Methamphetamine under 500 grams is guilty under this code section.",
		},
		10: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of Methamphetamine over 500 grams is guilty under this code section.",
		},
		11: {
			...
			fine: 10000,
			color: "orange",
			description: "A person who is carrying Methamphetamine, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		12: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of Oxy / Vicodin under 500 grams is guilty under this code section.",
		},
		13: {
			...
			fine: 4500,
			color: "green",
			description: "A person who is in possession of an amount of Oxy / Vicodin over 500 grams is guilty under this code section.",
		},
		14: {
			...
			fine: 12500,
			color: "orange",
			description: "A person who is carrying Oxy / Vicodin, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		15: {
			...
			fine: 3500,
			color: "green",
			description: "A person who is in possession of an amount of Ecstasy under 500 grams is guilty under this code section.",
		},
		16: {
			...
			fine: 4500,
			color: "green",
			description: "A person who is in possession of an amount of Ecstasy over 500 grams is guilty under this code section.",
		},
		17: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying Ecstasy, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		18: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of Opium under 500 grams is guilty under this code section.",
		},
		19: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of Opium over 500 grams is guilty under this code section.",
		},
		20: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying Opium, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		21: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of heroine under 500 grams is guilty under this code section.",
		},
		22: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of heroine over 500 grams is guilty under this code section.",
		},
		23: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying heroine, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		24: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of morphine under 500 grams is guilty under this code section.",
		},
		25: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of morphine over 500 grams is guilty under this code section.",
		},
		26: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying morphine, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		27: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of Adderall under 500 grams is guilty under this code section.",
		},
		28: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of Adderall over 500 grams is guilty under this code section.",
		},
		29: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying Adderall, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		30: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of Xanax under 500 grams is guilty under this code section.",
		},
		31: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of Xanax over 500 grams is guilty under this code section.",
		},
		32: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying Xanax, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		33: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of Shrooms under 500 grams is guilty under this code section.",
		},
		34: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of Shrooms over 500 grams is guilty under this code section.",
		},
		35: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying Shrooms, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		36: {
			...
			fine: 2500,
			color: "green",
			description: "A person who is in possession of an amount of Lean under 500 grams is guilty under this code section.",
		},
		37: {
			...
			fine: 5500,
			color: "green",
			description: "A person who is in possession of an amount of Lean over 500 grams is guilty under this code section.",
		},
		38: {
			...
			fine: 20000,
			color: "orange",
			description: "A person who is carrying Lean, either in a quantity over 1 kg, or packaged for sale, is guilty under this code section.",
		},
		39: {
		...
		42: {
			...
			fine: 50000,
			color: "red",
			description: "A person who unlawfully transports a large quantity of a controlled substance across, into or out of the state is guilty under this code section.",
		},
		43: {
...
PenalCode[7] = {
	...
	Statutes: {
		1: {
			...
			fine: 15000,
			color: "green",
			description: "A person who illegally possesses a weapon of Class A is guilty under this code section.",
		},
		2: {
			...
			fine: 20000,
			color: "green",
			description: "A person who illegally possesses a weapon of Class B is guilty under this code section.",
		},
		3: {
			...
			fine: 50000,
			color: "green",
			description: "A person who illegally possesses a weapon of Class C is guilty under this code section.",
		},
		4: {
			...
			fine: 75000,
			color: "green",
			description: "A person who illegally possesses a weapon of Class D is guilty under this code section.",
		},
		5: {
			...
			fine: 30000,
			color: "orange",
			description: "A person who illegally sells or distributes a weapon of Class A is guilty under this code section.",
		},
		6: {
			...
			fine: 50000,
			color: "orange",
			description: "A person who illegally sells or distributes a weapon of Class B is guilty under this code section.",
		},
		7: {
			...
			fine: 90000,
			color: "orange",
			description: "A person who illegally sells or distributes a weapon of Class C is guilty under this code section.",
		},
		8: {
			...
			fine: 110000,
			color: "orange",
			description: "A person who illegally sells or distributes a weapon of Class D is guilty under this code section.",
		},
		9: {
		...
		11: {
			...
			fine: 100000,
			color: "red",
			description: "A person who is responsible for the mass transportaion of illegal firearms and weapons across the state of San Andreas is guilty under this code section.",
		},
		12: {
...
PenalCode[8] = {
	...
	Statutes: {
		...
		5: {
			...
			fine: 350,
			color: "green",
			description: "A person who fails to obey a traffic control device, such as a stop sign, traffic lights, or yeild sign is guilty under this code section.",
		},
		6: {
			...
			fine: 750,
			color: "green",
			description: "A person who operates a motor vehicle on a public roadway, without the required vehicle equipment, such as brake lights and indicators, is guilty under this code section.",
		},
		7: {
		...
		9: {
			...
			fine: 650,
			color: "green",
			description: "A person who drives up to 10mph over the posted speed limit is guilty under this code section.",
		},
		10: {
			...
			fine: 1000,
			color: "green",
			description: "A person who drives up to 25 mph over the posted speed limit is guilty under this code section.",
		},
		11: {
			title: "Speeding 26+",
			class: "Infraction",
			...
			fine: 2000,
			color: "green",
			description: "A person who drives more than 26mph over the posted speed limit is guilty under this code section.",
		},
		12: {
		...
		18: {
			...
			fine: 1200,
			color: "green",
			description: "A person who fails to stop where it is indicated by traffic signs, is guilty under this code section.",
		},
		19: {
		...
		21: {
			...
			fine: 300,
			color: "green",
			description: "A person who operates a motor vehicle in low light conditions without their headlights switched on is guilty under this code section.",
		},
		22: {
			...
			fine: 15000,
			color: "green",
			description: "A person who attempts to or engages in racing or vehiclar contest on public roadways is guilty under this code section.",
		},
		23: {
		...
		24: {
			...
			fine: 1750,
			color: "green",
			description: "A person who operates a motor vehicle in the process of committing a crime is guilty under this code section.",
		},
		25: {
			...
			fine: 10000,
			color: "red",
			description: "A person who drives more than double the posted speed on any road-way is guilty under this code section.",
		},
	},
};
...
PenalCode[9] = {
	...
	Statutes: {
		1: {
			...
			fine: 4500,
			color: "green",
			description: "A person who hunts for game outside of the allocated hunting areas is guilty under this code section.",
		},
		2: {
		...
		4: {
			...
			fine: 4500,
			color: "green",
			description: "A person who hunts game with a weapon that is not a legal licensed hunting weapon is guilty under this code section.",
		},
		5: {
			...
			fine: 4500,
			color: "green",
			description: "A person who hunts game outside of the legal hours for hunting in that area is guilty under this code section.",
		},
		6: {
			title: "Overhunting",
			class: "Misdemeanor",
			...
			fine: 1000,
			color: "green",
			description: "A person who hunts over the amount allowed in that hunting area is guilty under this code section.",
		},
		7: {
			title: "Poaching",
			class: "Felony",
			...
			fine: 12500,
			color: "red",
			description: "A person who hunts for an endangered or protected species in the state of San Andreas is guilty under this code section.",
		},
	},
};
